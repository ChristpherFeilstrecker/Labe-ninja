...
import { baseURL, headers } from './credenciais/credenciais';
	  ...
	  trocaPagina = () => {
		switch (this.state.paginaAtual) {
		  ...
		  case ("Carrinho"):
			...
			case ("Produtos"):
				return <Produtos irParaCarrinho={this.irParaCarrinho} irParaHome={this.irParaHome} getAllJobs={this.getAllJobs} jobs={this.state.jobs}/>
		  default:
			return <Home/>
		}
	}
