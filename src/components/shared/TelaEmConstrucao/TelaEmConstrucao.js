...
export default function TelaEmConstrucao(props) {
  return (
    <div>
      <CardIcones>
        <Icone>
          <IconeIMG src={Icone1} alt="icone 2" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone2} alt="icone 2" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone3} alt="icone 3" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone4} alt="icone 4" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone5} alt="icone 5" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone6} alt="icone 6" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone7} alt="icone 7" />
        </Icone>
        <Icone>
          <IconeIMG src={Icone8} alt="icone 8" />
        </Icone>
      </CardIcones>
      <CarMainConstrucao>
        <TextoMain>
