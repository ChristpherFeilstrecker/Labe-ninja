  ...
  render() {
    return (
      <ConteinerPrincipal>
        <ConteinerIcones>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone1} alt="icone 2" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone2} alt="icone 2" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone3} alt="icone 3" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone4} alt="icone 4" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone5} alt="icone 5" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone6} alt="icone 6" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone7} alt="icone 7" />
          </ItemIcone>
          <ItemIcone>
            <img onClick={this.props.produtos} src={Icone8} alt="icone 8" />
          </ItemIcone>
        </ConteinerIcones>
        <ConteinerTexto>
          <div>
